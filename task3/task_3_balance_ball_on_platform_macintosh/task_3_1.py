...
def control_logic(center_x,center_y):
	...
	if(set_point[0]-640 > 0 and set_point[1]-640 > 0): 
		...
		# fix_error_x = -40
		fix_error_x = -((((-set_point[0]+900)/18671796)-(3/230516))*(set_point[0]-1043)+(100/403))*(set_point[0]-640)
		# fix_error_y = -(-((261*(1043-set_point[1]))/1070368)+0.198)*(set_point[1]-640)
		# fix_error_y = -40
		fix_error_y = -(((2359*(-set_point[0]+900)/3111966000)-(49/576290))*(set_point[0]-1043)+(85/403))*(set_point[0]-640)

	elif(set_point[0]-640 < 0 and set_point[1]-640 > 0): 
		# fix_error_x = ((((200-set_point[0]))/16896)-0.227)*(set_point[0]-640)
		# fix_error_x = 60
		fix_error_x = (640-set_point[0])/4
		# fix_error_y = -(-((57*(-1046+set_point[1]))/159616)+0.172)*(set_point[1]-640)
		# fix_error_y = -35
		fix_error_y = -((-(389*(set_point[1]-900)/4979145600)-(21/230516))*(set_point[1]-1043)+(85/403))*(set_point[1]-640)

	elif(set_point[0]-640 > 0 and set_point[1]-640 < 0): 
		# fix_error_x = -(((31*(-1046+set_point[0]))/279328)+0.197)*(set_point[0]-640)
		# fix_error_x = -40
		fix_error_x = ((-(23*(set_point[0]-900)/56015388)-(23/230516))*(set_point[0]-1043)-(95/403))*(set_point[0]-640)
		# fix_error_y = (-((7*(-200+set_point[1]))/52800)-0.209)*(set_point[1]-640)
		# fix_error_y = 50
		fix_error_y = (((19*(set_point[1]-300)/22440000)-(7/149600))*(set_point[1]-200)-(19/88))*(set_point[1]-640)
		...
		# fix_error_x = 60
		fix_error_x = (((37*(set_point[0]-200)/142560000)-(1/47520))*(set_point[0]-100)-(7/27))*(set_point[0]-640)
		# fix_error_y = (((320-set_point[1])/5280)-0.25)*(set_point[1]-640)
		# fix_error_y = 50
		fix_error_y = ((((set_point[1]-200)/4455000)-(7/237600))*(set_point[1]-100)-(23/108))*(set_point[1]-640)
