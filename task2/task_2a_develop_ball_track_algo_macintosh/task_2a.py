...
def get_vision_sensor_image():
	...
	return_code,image_resolution,vision_sensor_image=sim.simxGetVisionSensorImage(client_id,vs,0,sim.simx_opmode_streaming)
	while(sim.simxGetConnectionId(client_id)!=-1): 
		return_code,image_resolution,vision_sensor_image=sim.simxGetVisionSensorImage(client_id,vs,0,sim.simx_opmode_buffer)
