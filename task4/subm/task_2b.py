...
def send_data(client_id, maze_array):
	...
	for i in range(len(maze_array)):
		...
		# inputInts = [1,2,3]
		return_code,retInts,retFloats,retStrings,retBuffer=sim.simxCallScriptFunction(client_id,'top_plate_respondable_1',sim.sim_scripttype_customizationscript,
