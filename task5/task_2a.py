...
def get_vision_sensor_image2(vision_sensor_handle):
...
def transform_vision_sensor_image(vision_sensor_image, image_resolution):
	...
	pts1 = np.float32([[0, 0], [image_resolution[0], 0], [0, image_resolution[0]], [image_resolution[0], image_resolution[0]]])

	pts2 = np.float32([[0, 0], [1024, 0], [0, 1024], [1024, 1024]])
	matrix = cv2.getPerspectiveTransform(pts1, pts2)
	result = cv2.warpPerspective(flipVertical, matrix, (1024, 1024))
