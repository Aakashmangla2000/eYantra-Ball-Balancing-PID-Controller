...
vision_sensor_handle_1 = 0
vision_sensor_handle_4 = 0
vision_sensor_handle_5 = 0
...
def init_setup(rec_client_id):
	...
	"""
	global client_id, vision_sensor_handle, rj1,rj2,rj3,rj4,vision_sensor_handle_1,vision_sensor_handle_4,vision_sensor_handle_5
	# since client_id is defined in task_2a.py file, it needs to be assigned here as well.
	client_id = rec_client_id
	##############	ADD YOUR CODE HERE	##############
	return_code, vision_sensor_handle_1 = sim.simxGetObjectHandle(client_id, "vision_sensor_1", sim.simx_opmode_oneshot_wait)
	return_code, vision_sensor_handle_4 = sim.simxGetObjectHandle(client_id, "vision_sensor_4", sim.simx_opmode_oneshot_wait)
	return_code, vision_sensor_handle_5 = sim.simxGetObjectHandle(client_id, "vision_sensor_5", sim.simx_opmode_oneshot_wait)

	return_code, rj1 = sim.simxGetObjectHandle(client_id, "revolute_joint_ss_t4_1", sim.simx_opmode_oneshot_wait)
	return_code, rj2 = sim.simxGetObjectHandle(client_id, "revolute_joint_ss_t4_2", sim.simx_opmode_oneshot_wait)
	return_code, rj3 = sim.simxGetObjectHandle(client_id, "revolute_joint_ss_t1_1", sim.simx_opmode_oneshot_wait)
	return_code, rj4 = sim.simxGetObjectHandle(client_id, "revolute_joint_ss_t1_2", sim.simx_opmode_oneshot_wait)

	
	##################################################


def control_logic(center_x,center_y,table_num):
	"""
	Purpose:
	---
	...
	global ITerm_x,ITerm_y,f,rj1,rj2,rj3,rj4
	...
	if(table_num == 1):
		return_code = sim.simxSetJointTargetPosition(client_id, rj3,-PID_value_x,sim.simx_opmode_oneshot)
		return_code = sim.simxSetJointTargetPosition(client_id, rj4,-PID_value_y,sim.simx_opmode_oneshot)
	else: 
...
if __name__ == "__main__":
	...
	while(curr_simulation_time - init_simulation_time <=15):
		...
		try:
			vision_sensor_image, image_resolution, return_code = task_2a.get_vision_sensor_image(vision_sensor_handle_4)
